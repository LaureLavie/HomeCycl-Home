// front/app/inscription/finaliser/page.jsx
"use client";

import { Suspense, useState } from "react";
import { useSearchParams, useRouter } from "next/navigation";

// RESA-09/10/11 : finalisation du compte après une réservation anonyme
// useSearchParams() exige une frontière <Suspense> côté App Router
// (même pattern que front/app/reset-password/page.jsx)
export default function FinaliserInscriptionPage() {
  return (
    <Suspense fallback={null}>
      <FinaliserInscriptionForm />
    </Suspense>
  );
}

function FinaliserInscriptionForm() {
  ...
  return (
    <main className="container" style={{ maxWidth: "32rem", paddingBlock: "var(--space-xl)" }}>
      ...
      <p className="text-muted">
        Votre réservation a été enregistrée. Finalisez la création de votre
        compte pour la confirmer.
      </p>
